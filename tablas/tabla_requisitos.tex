...
REQ-03 & Portabilidad & El sistema deberá contar con ruedas y puntos de anclaje/asas que permitan su traslado, nivelación y fijación en un tiempo menor a 10 minutos. & Traslado, nivelación y fijación completados en $\leq$10 min, verificado por cronómetro. & Media & Prueba \\[3pt]

REQ-04 & Mecánico/Estructural & El chasis, incluyendo el sistema de rodamiento, deberá soportar sin deformación permanente ni pérdida de estabilidad el peso total del sistema con los tres tanques llenos, tanto en reposo como durante el desplazamiento. & Sin deformación visible ni volcamiento con los tres tanques llenos, verificado en prueba de carga estática y en prueba de desplazamiento cargado. & Alta & Prueba \\[3pt]
...
REQ-06 & Hidráulico & El sistema deberá contar con tres tanques independientes (agua/mezcla, jabón y agua residual) con capacidad suficiente para completar un ciclo de lavado, y con conexiones herméticas que eviten fugas durante todo el proceso. & Cero fugas visibles durante prueba de llenado y ciclo completo de operación, con verificación de que ningún tanque se agota antes de finalizar el ciclo. & Alta & Prueba/ Inspección \\[3pt]
